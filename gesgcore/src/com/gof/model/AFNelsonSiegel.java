...
import com.gof.model.hw.SmithWilson;
...
//		this.inputParas = new double[] {   // JAVA DNS
//				  0.47616903890804885
//				  , 0.03359240577156057
//				  , -0.017727177222447068
//				  , 0.0052010476166935125
//				  , 0.10108455380215074
//				  , 0.3835600867519039
//				  , 0.30911298636085494
//				  , 0.0061779793087011516
//				  , -0.005882429491797533
//				  , 0.0030903458308824414
//				  , 9.78032246045241E-4
//				  , -4.097899522242011E-4
//				  , 0.010729307098797226
//				  , 0.3160995199327225
//		};
//		//this.optParas = this.inputParas;
//		
//		this.optLSC = new double[] {
//				  0.024716768598674374
//				  , -0.010274616958204577
//				  , 0.009894981910181386   };		
...
//			SmithWilsonKics sw = new SmithWilsonKics(this.baseDate, ts, CMPD_MTD_CONT, true, irDiscToCont(ltfr), this.ltfrT, this.prjYear, 1, 20, this.dayCountBasis);
			SmithWilson sw = new SmithWilson(this.baseDate, ts, CMPD_MTD_CONT, true, irDiscToCont(ltfr), this.ltfrT, this.prjYear, 1, 20, this.dayCountBasis);			
