...
public abstract class IrmodelDb {
	...
	protected Map<String, IrmodelResultDb>  resultMap         = new TreeMap<String, IrmodelResultDb>();
	protected List<IrmodelResultDb>         resultList        = new ArrayList<IrmodelResultDb>();
