...
import com.gof.model.db.AFNelsonSiegelDb;
 ...
 * @version 1.0
 */
public class Job28_AfnsScenarioDb {	
	private final static Logger log = LoggerFactory.getLogger("Job");
	
	public static Map<String, List<?>> createAfnsShockScenario(String bssd, String mode, double[] intiParam, double[] initLcs, String irCurveId, String baseCurveId, List<String> tenorList, 
...
//		List<IrCurveHis> curveHisList  = IrCurveHisShockDao.getIrCurveListTermStructureForShock(bssd, stBssd, irCurveId, tenorList);
		...
		AFNelsonSiegelDb afns;
		
		if(intiParam == null) {
			afns = new AFNelsonSiegelDb(Irmodel.stringToDate(bssd), mode, null, curveHisList, curveBaseList,
			...
			afns = new AFNelsonSiegelDb(Irmodel.stringToDate(bssd), mode, null, intiParam, initLcs, curveHisList, curveBaseList,
					isRealNumber, cmpdMtd, dt, initSigma, dayCountBasis, ltfrL, ltfrA, ltfrT, liqPrem, 1.0 / 12, 
					minLambda, maxLambda, 3, prjYear, errorTolerance, itrMax, confInterval, epsilon);
